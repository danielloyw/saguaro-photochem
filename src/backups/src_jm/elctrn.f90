SUBROUTINE ELCTRN 
  ...
  READ (60,*) nelb, nabs_el_thk, nabs_el_thn, nbrn_max, nprmax_el

  nabs_el = nabs_el_thk + nabs_el_thn
  ...
  READ(60,'(A)') header
  READ(60,'(10(ES13.5))') elctreV
  READ(60,'(A)') header
  READ(60,'(10(ES13.5))') elctDeV

  nert = 0; na = 0
  DO n = 1, nabs_el_thk     
     READ(60,'(A12, I4, I4, I4)') xname, nabs_excite, nabs_dissoc, nabs_ioniz
     ...
     READ(60,'(A)') header
     READ(60,'(10ES11.3)') (eCS_tot_elast(i,na),i=1,nelb)
     READ(60,'(A)') header
     READ(60,'(10ES11.3)') (eCS_tot_inelast(i,na),i=1,nelb)
     ! .. read excited states
     DO nx = 1, nabs_excite
        READ (60,'(A10,E6.3)') yname, yenrg
        state(na,nx) = yname
        enrgE(na,nx) = yenrg
        READ(60,'(10ES11.3)') (eCS(ne,na,nx),ne=1,nelb)
     END DO
     ...
     DO nb = 1, nbrnch_el(na)
        ...
        END DO
        nprdcts_el(nb,na) = np
        READ(60,'(10ES11.3)') (eCS(ne,na,nabs_excite+nb),ne=1,nelb)
     END DO
  END DO
  ...
  ALLOCATE(sum_cs_rees_ion(nelb,nabs_el,5),sum_cs_rees_sec(nelb,nabs_el,5))
  
  !  .. Total cross sections for e-impact excitation and ionization of N2 and CH4
