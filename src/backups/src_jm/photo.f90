SUBROUTINE PHOTO 
  ...
  file_sol_ionz = '../data/solar/source_ionz_T40.dat'
  file_sol_bnd = '../data/solar/source_bnd_T40.dat'
  file_sol_uv = '../data/solar/source_uv_T40.dat'
  ...
  CALL READ_PHOTO(name,file_photoA,nbrnchA,loabA,loprA,ionizeA,enrgIA,charge_stateA,phrctA,         & 
    wcrsA,xcrsA,bratA)
  ...
  !
  !  .. Interpolate Solar Spectrum to A, B, C Grids
  !
  
  CALL INTRP(wav_sol_hres,flx_sol_hres,wcrsB,fsolB)

  !
  !  .. Convert High Res Spectrum from ph/cm2/s/A to ph/cm2/s
  !
